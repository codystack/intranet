...
<!--end:Dashboards menu--></div><!--end:Menu sub--></div><!--end:Menu item--><!--begin:Menu item--><div  data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"  class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2" ><!--begin:Menu link--><span class="menu-link"  ><span  class="menu-title" >Help</span><span  class="menu-arrow d-lg-none" ></span></span><!--end:Menu link--><!--begin:Menu sub--><div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px" ><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="../../../../html/keen/docs/base/utilities.html" target="_blank" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right"  ><span  class="menu-icon" ><i class="ki-duotone ki-rocket fs-2"><span class="path1"></span><span class="path2"></span></i></span><span  class="menu-title" >Components</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="../../../../html/keen/docs/index.html" target="_blank" title="Check out the complete documentation" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right"  ><span  class="menu-icon" ><i class="ki-duotone ki-abstract-26 fs-2"><span class="path1"></span><span class="path2"></span></i></span><span  class="menu-title" >Documentation</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="../../../../html/keen/docs/getting-started/changelog.html" target="_blank"  ><span  class="menu-icon" ><i class="ki-duotone ki-code fs-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i></span><span  class="menu-title" >Changelog v3.0.8</span></a><!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub--></div><!--end:Menu item-->    </div>
    <!--end::Menu-->
</div>
<!--end::Menu wrapper-->
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
	<!--begin::Heading-->
    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('../../assets/media/misc/menu-header-bg.jpg.png')">
        <!--begin::Title-->                                   
...
<div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
    <a 
        href="../../../../html/keen/docs/index.html" 
...
<!--end::Card header-->
		...
		<div class="card-body position-relative" id="kt_app_layout_builder_body">
			...
			<div id="kt_app_settings_content"
				...
				<!--begin::Form-->
				<form class="form" method="POST" id="kt_app_layout_builder_form" action="../../index.php.html">
...
<div class="form-group">
	...
	<div class="mb-6">
		...
		<div class="fw-semibold text-muted fs-7 d-block lh-1">
			...
			<a class="fw-semibold" href="../../../../html/keen/docs/getting-started/dark-mode.html" target="_blank">See docs</a>
		</div>
	</div>
	<!--end::Heading-->  
...
<div class="form-group d-flex flex-stack">           
	...
	<div class="d-flex flex-column">
		...
		<div class="fs-7 fw-semibold text-muted">
			...
			<a class="fw-semibold" href="../../../../html/keen/docs/getting-started/rtl.html" target="_blank">See docs</a>
		</div>	
	</div>
	<!--end::Heading-->
...
<div class="form-group ">            
	...
	<div class="d-flex flex-column mb-4">
		...
		<div>
			...
			<a class="fw-semibold" href="../../../../html/keen/docs/icons/keenicons.html" target="_blank">Learn more</a>
		</div>
	</div>
	<!--end::Heading-->
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="overflow-auto pb-5">
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    <!--begin::Icon-->                                  
                    <img alt="/keen/demo1/apps/projects/project.html" class="w-30px me-3" src="../../assets/media/svg/files/doc.svg"/>
                    <!--end::Icon--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    <!--begin::Icon-->                                  
                    <img alt="/keen/demo1/apps/projects/project.html" class="w-30px me-3" src="../../assets/media/svg/files/css.svg"/>
                    <!--end::Icon--> 
		...
		<div class="card-body" id="kt_help_body">
			...
			<div 
				...
				<!--end::Support-->
					...
					<!--end::Link-->
																			<!--begin::Link-->
					<a href="../../../../html/keen/docs/getting-started/changelog.html"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
