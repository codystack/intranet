            ...
            <div class="app-container  container-fluid d-flex align-items-stretch justify-content-between "
                ...
                <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                    <a href="dashboard" class="d-lg-none">
                        <img alt="Logo" src="assets/media/logos/vinelogo.png" class="theme-light-show h-30px" />
                        <img alt="Logo" src="assets/media/logos/vinelogo_white.png" class="theme-dark-show h-30px" />
                    </a>
                </div>
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span class="badge badge-light-danger fw-bold fs-8 px-2 py-1 mt-2"><?= $designation ?></span>
                                        </div>
                                    </div>
                                </div>
